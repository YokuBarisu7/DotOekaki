...
public class DengonPreviewGenerator : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        DengonDrawingManager.instance.OnColorChanged += HandleColorChanged;
        DengonDrawingManager.instance.OnBrushSizeChanged += HandleBrushSizeChanged;
        DengonDrawingManager.instance.OnToolModeChanged += HandleToolModeChanged;
        DengonDrawingManager.instance.OnFieldSizeChanged += HandleFieldResized;
    }

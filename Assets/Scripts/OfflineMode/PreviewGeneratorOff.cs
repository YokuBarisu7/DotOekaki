...
public class PreviewGeneratorOff : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        DrawingManagerOff.instance.OnColorChanged += HandleColorChanged;
        DrawingManagerOff.instance.OnBrushSizeChanged += HandleBrushSizeChanged;
        DrawingManagerOff.instance.OnToolModeChanged += HandleToolModeChanged;
        DrawingManagerOff.instance.OnFieldSizeChanged += HandleFieldResized;
    }

    private void OnDisable()
    {
        if (DrawingManagerOff.instance == null) return;

...
using static EshiritoriDrawingManager;
...
public class EshiritoriPreviewGenerator : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        EshiritoriDrawingManager.instance.OnColorChanged += HandleColorChanged;
        EshiritoriDrawingManager.instance.OnBrushSizeChanged += HandleBrushSizeChanged;
        EshiritoriDrawingManager.instance.OnToolModeChanged += HandleToolModeChanged;
        EshiritoriDrawingManager.instance.OnFieldSizeChanged += HandleFieldResized;
    }
